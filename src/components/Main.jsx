...
const Main = ({ noteBtnClick, isMobile }) => {
  ...
  return (
    <div className={`main ${noteGroups && isMobile && noteGroups.length > 0 ? "none" : "flex"}`}>
      <img src={background} alt="img" width="400px" className="main-img" />
      <p className="main-title">Pocket Notes</p>
